...
export default function NuevoHotelPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: insertError } = await supabase.from("hoteles").insert([
        {
      ...
      if (insertError) {
        console.error("Error al insertar hotel:", insertError.message);
        throw insertError;
      }
      ...
      setError("Error al guardar el hotel. Revisa los campos.");
    }
  };
